...
describe("OpenAI producer to transport collector integration", () => {
  ...
  it("projects compatible Anthropic clean EOF as semantic uncertainty after the attempt", async () => {
  ...
  it("projects injected Anthropic token refresh and clean EOF without inventing attempts", async () => {
    const compatibleModel = {
      ...anthropicModel,
      id: "claude-sonnet-4-6",
      name: "Claude Sonnet 4.6",
